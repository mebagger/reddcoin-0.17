...
// PoSV: temperature to measure how many PoS headers have been sent by this client
...
static void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "Reddcoin " + FormatFullVersion();
    ...
    nSendVersion(0)
{
    ...
    fPauseSend = false;
    nProcessQueueSize = 0;
    lastAcceptedHeader = uint256(); //PoSV
