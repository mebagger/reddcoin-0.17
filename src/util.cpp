...
const char * const BITCOIN_PID_FILENAME = "reddcoind.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Reddcoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Reddcoin
